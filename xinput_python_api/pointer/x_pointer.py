from ..parser import get_mouse_devices_data
...
class XPointer:
    def __init__(self, pointer_data: dict, debug=False):
        self.id = pointer_data['id']
        self.name = pointer_data['device_name']
        self.buttons_map = XPointerButtons(pointer_data['id'], pointer_data['button_map'], debug=debug)
